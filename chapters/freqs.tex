...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		\begin{semilogxaxis}[xlabel=$\omega/\omega_0$, ylabel=$\tau_g(\omega)\slash\unit{\second}$, xmin=0.1, xmax=10, grid=major]
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		\begin{semilogxaxis}[xlabel=$\omega/\omega_0$, ylabel=$|H(\omega)|^2\slash\unit{\decibel}$, xmin=0.1, xmax=10, ymin=0, grid=major]
